...
void loop(){
 ...
 if(type == 2){ //Guitar Hero Controller
  ...
  if(pos1>0) {
    ...
    myservoright.write(pos2);
    myservoleft.write(pos1);
...
void RightMotor(bool enableR, bool forwardR)
{
  digitalWrite(4,enableR);
  digitalWrite(7,forwardR);
  digitalWrite(13,!forwardR);
}
void LeftMotor(bool enableL, bool forwardL) 
{
  digitalWrite(A0, enableL);
  digitalWrite(A1, forwardL);
  digitalWrite(A2, !forwardL);
}
